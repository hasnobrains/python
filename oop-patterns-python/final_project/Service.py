...
def create_sprite(img, sprite_size):
    print(f'Creating sprite {img} {sprite_size}')
...
def service_init(sprite_size, full=True):
    ...
    icon = os.path.join("texture", "wall.png")
    wall[0] = create_sprite(icon, sprite_size)

    icon = os.path.join("texture", "Ground_1.png")
    floor1[0] = create_sprite(icon, sprite_size)

    icon = os.path.join("texture", "Ground_2.png")
    floor2[0] = create_sprite(icon, sprite_size)

    icon = os.path.join("texture", "Ground_3.png")
    floor3[0] = create_sprite(icon, sprite_size)
